<?php 
	include 'dbconn.php';
	$id=$_GET['updateuser'];
	$sql = "SELECT * FROM test_login WHERE LID = '$id'";
	...
	if (isset($_POST['submit'])) {
        ...
        $checkquery = "SELECT * from test_login WHERE USERNAME = '$user'";
        ...
        if ($rs)
        {
            ...
            if (mysqli_num_rows($rs) > 0)
            {
                ...
                echo '</script>';  
                $sql = "UPDATE test_login SET LID = '$id',
                FIRST = '$first',
                LAST = '$last',
                USERNAME = '$user', 
                PASSWORD = '$password'
...
<body id="page-top">
    <form action="SBRegistrationInsertProcess.php" method="POST" enctype="multipart/form-data"> 
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">User information</h3>
                    <div class="row mb-3">
                        <div class="col-lg-4 col-xl-3">
                            <div class="card mb-3">
                                <div class="card-body text-center shadow"><img class="rounded-circle mb-3 mt-4" src="assets/img/dogs/san%20bartolome.jpg" width="160" height="160">
                                    <div class="mb-3"></div><strong>San Bartolome Users</strong>
                                </div>
                            </div>
                                ...
                                <div class="col">
                                    <div class="card shadow mb-3">
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="username"><strong>First name</strong></label><input class="form-control" type="text" id="username-1" placeholder="Ex. Juan" value="<?php echo $firstrow ?>" pattern="[A-Za-z ]{1,}" name="first" required></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="email"><strong>Last name</strong></label><input class="form-control" type="text" id="email-1" placeholder="Ex. Dela Cruz" value="<?php echo $lastrow ?>" name="last" required></div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="first_name"><strong>Username</strong></label><input class="form-control" type="text" id="first_name-1" placeholder="Ex. ishrmrz" value="<?php echo $userrow ?>" name="user" required></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="first_name"><strong>Password</strong></label><input class="form-control" type="text" id="first_name-1" placeholder="Password" value="<?php echo $passwordrow ?>" name="password" required></div>
                                                    </div>
                                                </div>
                                    </div>
                                        <div class="card-body">
