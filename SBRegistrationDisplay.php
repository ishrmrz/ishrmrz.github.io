<?php
    ...
    function displayRegistration()
    {
        ...
        if (isset($_POST['search'])) {
            ...
            $sqlresult = mysqli_query($conn, "select * from test_login WHERE USERNAME LIKE '%$search%'");
        } else {
            $sqlresult = mysqli_query($conn, "select * from test_login");
        }
        ...
        while ($row = mysqli_fetch_array($sqlresult)) {
            ...
            ?>
                ...
                <td><a class="btn btn-primary" onclick="return confirm('Are you sure you want to update?')" href="SBRegistrationUpdate.php?updateuser=<?php echo $row['LID']; ?>">Edit</a>&nbsp;
					<a class="btn btn-secondary" onclick="return confirm('Are you sure you want to delete?')" href="SBRegistrationDelete.php?deleteuser=<?php echo $row['LID']; ?>">Delete</a></td>
...
<body id="page-top">
    <form action = "SBRegistrationDisplay.php" method="POST" enctype="multipart/form-data"> 
    <div id="wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">User Display</p>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="input-group mt-3">
                            ...
                            placeholder="Enter name of User" name="searchname">
