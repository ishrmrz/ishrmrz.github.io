<?php
    ...
    function displayWedding()
    {
        ...
        while ($row = mysqli_fetch_array($sqlresult)) {
            ...
            <td><a class="btn btn-primary" href="SBWeddingDisplayDownload.php?cfile=<?php echo $row['CENOMAR']; ?>">Download</a></td>         
                        ...
                        <div style="overflow-x:auto;">
                            <table class="table" >
                                <thread>
                                    ...
                                    <th>Certificate of No Marriage</th>
                                    <th>Baptismal Bride File</th>
                                    <th>Baptismal Groom File</th>
                                    <th>Confirmation Bride File</th>
                                    <th>Confirmation Groom File</th>
                                    <th>Birth Certificate Bride</th>
                                    <th>Birth Certificate Groom</th>
