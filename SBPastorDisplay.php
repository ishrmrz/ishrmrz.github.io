<?php
    ...
    function displayPastoral()
    {
        include "dbconn.php";
        if (isset($_POST['search'])) {
            $search = $_POST['searchname'];
            $sqlresult = mysqli_query($conn, "select * from test_pastor WHERE PASTOR LIKE '%$search%'");
        } else {
            $sqlresult = mysqli_query($conn, "select * from test_pastor");
        }
        ...
        while ($row = mysqli_fetch_array($sqlresult)) {
            ...
            ?>
                ...
                <td><a class="btn btn-primary" onclick="return confirm('Are you sure you want to update?')" href="SBPastorUpdate.php?updateuser=<?php echo $row['PID']; ?>">Edit</a>&nbsp;
					<a class="btn btn-secondary" onclick="return confirm('Are you sure you want to delete?')" href="SBPastorDelete.php?deleteuser=<?php echo $row['PID']; ?>">Delete</a></td>
...
<head>
    ...
    <title>San Bartolome Admin</title>
...
<body id="page-top">
    <form action = "SBPastorDisplay.php" method="POST" enctype="multipart/form-data"> 
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Pastoral Information</h3>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Pastoral Display</p>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="input-group mt-3">
                            ...
                            placeholder="Enter name of Pastor" name="searchname">

                            <button type="submit" class="btn btn-primary btn-lg w-60 h-30" name="search">Search 
                            </button> &nbsp;&nbsp;
                            <a class="btn btn-secondary"href="SBPastorDisplay.php" style="font-size: 20px">Refresh</a>
                        </div>
