<?php 
	include 'dbconn.php';
	$id=$_GET['updateuser'];
	$sql = "SELECT * FROM test_baptismal WHERE BID = '$id'";
	...
	if (isset($_POST['submit'])) {
        ...
        if ($rs)
        {
            ...
            {
                $sql = "UPDATE test_baptismal SET BID = '$id',
                CHILD = '$baby',
                FATHER = '$father', 
                MOTHER = '$mother',
                BIRTHDATE = '$birthdate',
                                ...
                                <div class="col">
                                    <div class="card shadow mb-3">
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="username"><strong>Child name</strong></label><input class="form-control" type="text" id="username-1" placeholder="Name of Child" pattern="[A-Za-z ]{1,}" value="<?php echo $babyrow ?>" name="child" required></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="email"><strong>Father's name</strong></label><input class="form-control" type="text" id="email-1" placeholder="Name of Father" pattern="[A-Za-z ]{1,}" value="<?php echo $fatherrow ?>"  name="father" required></div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="first_name"><strong>Mother's name</strong></label><input class="form-control" type="text" id="first_name-1" placeholder="Name of Mother" pattern="[A-Za-z ]{1,}" value="<?php echo $motherrow ?>"  name="mother" required></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="last_name"><strong>Date of Birth</strong></label><input class="form-control" type="date" id="date" value="<?php echo $birthdaterow ?>" pattern="[A-Za-z ]{1,}" name="birthdate" required></div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="last_name"><strong>Date of Baptismal</strong></label><input class="form-control" type="date" id="date" min="<?= date('Y-m-d', strtotime('+1 month')); ?>" value="<?php echo $bapdaterow ?>"  name="bapdate" required></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3">
