<script>
  ...
  var selectedFile = document.getElementById("download-menu").value;

  // Download the selected file
  window.location.href = "SBWeddingDisplayDownload.php?cfile=<?php echo $row['CENOMAR']; ?>>";
});
</script>
<?php
    ...
    function displayWedding()
    {
        ...
        while ($row = mysqli_fetch_array($sqlresult)) {
            ...
            <td><select id="download-menu">
                <option value="SBWeddingDisplayDownload.php?cfile=<?php echo $row['CENOMAR']; ?>">CENOMAR</option>
                <option value="SBWedding/BAPBRIDE.pdf">BAP Bride</option>
...
<body id="page-top">
    <form action = "SBWeddingDisplay2.php" method="POST" enctype="multipart/form-data"> 
    <div id="wrapper">
