<?php
    ...
    function displayWedding()
    {
        ...
        if (isset($_POST['search'])) {
            ...
            $sqlresult = mysqli_query($conn, "select * from test_wedding WHERE bride LIKE '%$search%' OR groom LIKE '%$search%'");
        } else {
        ...
        while ($row = mysqli_fetch_array($sqlresult)) {
            ...
            <?php /*<td><a class="btn btn-primary" href="SBWeddingDisplayDownload.php?cfile=<?php echo $row['CENOMAR']; ?>">Download</a></td>         
            <td><a class="btn btn-primary" href="SBWeddingDisplayDownload.php?bapbfile=<?php echo $row['BAPBRIDE']; ?>" >Download</a></td>
            <td><a class="btn btn-primary" href="SBWeddingDisplayDownload.php?bapgfile=<?php echo $row['BAPGROOM']; ?>">Download</a></td>
            <td><a class="btn btn-primary" href="SBWeddingDisplayDownload.php?confbfile=<?php echo $row['CONFBRIDE']; ?>">Download</a></td>
            <td><a class="btn btn-primary" href="SBWeddingDisplayDownload.php?confgfile=<?php echo $row['CONFGROOM']; ?>">Download</a></td>
            <td><a class="btn btn-primary" href="SBWeddingDisplayDownload.php?birthbridefile=<?php echo $row['BIRTHCERTBRIDE']; ?>">Download</a></td>
            <td><a class="btn btn-primary" href="SBWeddingDisplayDownload.php?birthgroomfile=<?php echo $row['BIRTHCERTGROOM']; ?>">Download</a></td>
            <td><a class="btn btn-primary" href="SBWeddingDisplayDownload.php?marcertfile=<?php echo $row['MARRIAGECERT']; ?>">Download</a></td>
            */?>
            ...
            <td>
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href= "SBWeddingDisplayDownload.php?cfile=<?php echo $row['CENOMAR']; ?>">Cenomar</a>
                        <a class="dropdown-item" href="SBWeddingDisplayDownload.php?bapbfile=<?php echo $row['BAPBRIDE']; ?>">Baptismal Bride</a>
                        <a class="dropdown-item" href="SBWeddingDisplayDownload.php?bapgfile=<?php echo $row['BAPGROOM']; ?>">Baptismal Groom</a>
                        <a class="dropdown-item" href="SBWeddingDisplayDownload.php?confbfile=<?php echo $row['CONFBRIDE']; ?>">Confirmation Bride</a>
                        <a class="dropdown-item" href="SBWeddingDisplayDownload.php?confgfile=<?php echo $row['CONFGROOM']; ?>">Confirmaton Groom</a>
                        <a class="dropdown-item" href="SBWeddingDisplayDownload.php?birthbridefile=<?php echo $row['BIRTHCERTBRIDE']; ?>">Birth Certificate Bride</a>
                        <a class="dropdown-item" href="SBWeddingDisplayDownload.php?birthgroomfile=<?php echo $row['BIRTHCERTGROOM']; ?>">Birth Certificate Groom</a>
                        <a class="dropdown-item" href="SBWeddingDisplayDownload.php?marcertfile=<?php echo $row['MARRIAGECERT']; ?>">Marriage Certificate</a>
                    </div>
                </div>
            </td>
            ...
            ?>
                ...
                <td><a class="btn btn-primary" onclick="return confirm('Are you sure you want to update?')" href="SBWeddingUpdate.php?updateuser=<?php echo $row['WID']; ?>">Edit</a>&nbsp;
					<a class="btn btn-secondary" onclick="return confirm('Are you sure you want to delete?')" href="SBWeddingDelete.php?deleteuser=<?php echo $row['WID']; ?>">Delete</a></td>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow">
                        ...
                        <div class="input-group mt-3">
                            ...
                            placeholder="Enter bride or groom name" name="searchname">

                            <button type="submit" class="btn btn-primary btn-lg w-60 h-30" name="search">Search 
                            </button> &nbsp;&nbsp;
                            <a class="btn btn-secondary"href="SBWeddingDisplay.php" style="font-size: 20px">Refresh</a>
                        </div>
