...
<body id="page-top">
    <form action="SBConfirmationInsertProcess.php" method="POST" enctype="multipart/form-data"> 
    <div id="wrapper">
                                ...
                                <div class="col">
                                    <div class="card shadow mb-3">
                                        <div class="card-header py-3">
                                            <p class="text-primary m-0 fw-bold">Confirmation Details</p>
                                        </div>
                                        <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="first_name"><strong>Mother's name</strong></label><input class="form-control" type="text" id="first_name-1" placeholder="Ex. Juana Dela Cruz" pattern="[A-Za-z ]{1,}" name="mother" required></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="last_name"><strong>Date of Birth</strong></label><input class="form-control" type="date" id="date" name="birthdate" max="<?= date('Y-m-d'); ?>" required></div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="last_name"><strong>Date of Confirmation</strong></label><input class="form-control" type="date" id="date" name="confdate" min="<?= date('Y-m-t'); ?>" max="<?= date('Y-m-t', strtotime('August')); ?>" required></div>
                                                    </div>
                                                    <div class="col">
                                                    <div class="col">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row"> 
                                                ...
                                                <div class="col">
                                                    <div class="mb-3"><label class="form-label" for="username"><strong>Name of Godmother</strong></label><input class="form-control" type="text" id="birthcertbaby" placeholder="Ex. Juana Dela Cruz" pattern="[A-Za-z ]{1,}" name="ninang" required></div>
                                                </div>
                                                <div class="col">
