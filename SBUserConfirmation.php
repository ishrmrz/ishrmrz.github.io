    ...
    <div class="container"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -64 640 640" width="1em" height="1em" fill="currentColor" style="padding-right: 0px;margin-right: 10px;width: 30px;height: 30px;">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="SBUserConfirmation.php">Confirmations</a></li>
            ...
            <div class="row gy-4 gy-md-0">
                <div class="col-md-6 text-center text-md-start d-flex d-sm-flex d-md-flex justify-content-center align-items-center justify-content-md-start align-items-md-center justify-content-xl-center">
                    <div style="max-width: 550px;">
                        <h1 class="display-5 fw-bold mb-4">Ready for your child to be confirmed?</h1>
                        <p class="text-muted my-2">Here are the requirements for Confirmation:</p>
                        <p class="text-muted my-2">-Name of child</p>
                        <p class="text-muted my-2">-Name of Father</p>
                        <p class="text-muted my-2">-Name of Mother</p>
                        <p class="text-muted my-2">-Date of Birth</p>
                        <p class="text-muted my-2">-Date of Confirmation</p>
                        <p class="text-muted my-2">-Name of Priest</p>
                        <p class="text-muted my-2">-Name of Godfather</p>
                        <p class="text-muted my-2">-Name of Godmother</p>
                        <a class="btn btn-outline-primary btn-lg" role="button" href="SBUserConfirmationInsert.php">Reserve now!</a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div><img class="rounded img-fluid w-100 fit-cover" style="min-height: 300px;" src="img/conf1.jpg"></div>
                </div>
            </div>
        </div>
    </section>
