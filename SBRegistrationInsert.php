                                ...
                                <div class="col">
                                    <div class="card shadow mb-3">
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="username"><strong>First name</strong></label><input class="form-control" type="text" id="username-1" placeholder="Ex. Juan" pattern="[A-Za-z ]{1,}" name="first" required></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="email"><strong>Last name</strong></label><input class="form-control" type="text" id="email-1" placeholder="Ex. Dela Cruz" name="last" required></div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="first_name"><strong>Username</strong></label><input class="form-control" type="text" id="first_name-1" placeholder="Ex. ishrmrz" name="user" required></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="first_name"><strong>Password</strong></label><input class="form-control" type="password" id="first_name-1" placeholder="Password" name="password" required></div>
                                                    </div>
                                                </div>
                                    </div>
                                        <div class="card-body">
