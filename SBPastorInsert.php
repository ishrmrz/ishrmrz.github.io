...
<body id="page-top">
    <form action="SBPastorInsertProcess.php" method="POST" enctype="multipart/form-data"> 
    <div id="wrapper">
                                ...
                                <div class="col">
                                    <div class="card shadow mb-3">
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="username"><strong>Pastor name</strong></label><input class="form-control" type="text" id="username-1" placeholder="Name of Pastor" pattern="[A-Za-z ]{1,}" name="pastor" required></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="email"><strong>Age</strong></label><input class="form-control" type="text" id="email-1" placeholder="Age" name="age" pattern="[0-9]{2}" min="18" max="75" required></div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="first_name"><strong>Contact Number</strong></label><input class="form-control" type="text" id="first_name-1" placeholder="Ex. 09123456789" pattern="[0-9]{11}" name="contact" required></div>
                                                    </div>
                                                </div>
                                    </div>
                                        <div class="card-body">
