...
<body id="page-top">
    <form action="SBWeddingInsertProcess.php" method="POST" enctype="multipart/form-data"> 
        <div id="wrapper">
                                    ...
                                    <div class="col">
                                        <div class="card shadow mb-3">
                                            ...
                                            <div class="card-body" style="padding-bottom: 239px;margin-bottom: -161px;">   
                                                    <div class="row">
                                                        <div class="col">
                                                            <div class="mb-3"><label class="form-label" for="bride name"><strong>Bride Name</strong></label><input class="form-control" type="text" id="bride" pattern="[A-Za-z ]{1,}" placeholder="Ex: Maria Dela Cruz" name="bride" required></div>
                                                        </div>
                                                        <div class="col">
                                                            <div class="mb-3"><label class="form-label" for="groom name"><strong>Groom Name</strong></label><input class="form-control" type="text" id="groom" pattern="[A-Za-z ]{1,}" placeholder="Ex: Juan Dela Cruz" name="groom" required></div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col">
                                                            <div class="mb-3"><label class="form-label" for="wedding date"><strong>Date of Wedding</strong><br></label></div><input class="form-control" type="date" id="date" name="date" min="<?php echo date("Y-m-d"); ?>"  required>
                                                        </div>
                                                        <div class="col">
                                                    ...
                                                    <div class="mb-3"><label class="form-label" for="first_name"><strong>Package Type for Wedding</strong></label><select class="form-select" name="package" id="package">
