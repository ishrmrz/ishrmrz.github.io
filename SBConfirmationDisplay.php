<?php
    ...
    function displayBaptismal()
    {
        ...
        if (isset($_POST['search'])) {
            ...
            $sqlresult = mysqli_query($conn, "select * from test_confirmation WHERE PERSON LIKE '%$search%'");
        } else {
            $sqlresult = mysqli_query($conn, "select * from test_confirmation");
        }
        ...
        while ($row = mysqli_fetch_array($sqlresult)) {
            ...
            echo "<td>$row[9]</td>"; 
            ?>        
            <!-- <td><a class="btn btn-primary" href="SBConfirmationDisplayDownload.php?bapfile=<?php // echo $row['BAPCERT']; ?>">Download</a></td> -->
            ...
            // echo '<td><img src="data:image/jpg; base64,' . base64_encode($row['CONFPIC']) . '"height="100"width="100"/></td>';  
            ?>

                <td><a class="btn btn-primary" onclick="return confirm('Are you sure you want to update?')"  href="SBConfirmationUpdate.php?updateuser=<?php echo $row['CONFID']; ?>">Edit</a>&nbsp;
					<a class="btn btn-secondary" onclick="return confirm('Are you sure you want to delete?')" href="SBConfirmationDelete.php?deleteuser=<?php echo $row['CONFID']; ?>">Delete</a></td>
...
<head>
    ...
    <title>Confirmation Table</title>
...
<body id="page-top">
    <form action = "SBConfirmationDisplay.php" method="POST" enctype="multipart/form-data"> 
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Confirmation Information</h3>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Confirmation Display</p>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="input-group mt-3">
                            ...
                            placeholder="Enter your name" name="searchname">

                            <button type="submit" class="btn btn-primary btn-lg w-60 h-30" name="search">Search 
                            </button> &nbsp;&nbsp;
                            <a class="btn btn-secondary"href="SBConfirmationDisplay.php" style="font-size: 20px">Refresh</a>
                        </div>
